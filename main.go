...
func main() {
	fmt.Println("Привет, я калькулятор на Golang, поддерживаю операции 'a + b, a - b, a * b, a / b'.\nУмею работать как с арабскими, так и с римскими цифрами,  но не с двумя сразу.\nЧтобы выйти из меня напиши команду 'exit'.")
